...
%\usepackage{mathptmx}        % Times font with math symbols from the Sym­bol, Chancery and Com­puter Modern fonts
...
% example:   $\ddfrac{TP+TN}{\Sigma Total Population}$
...
%\definecolor{darkgreen}{rgb}{0,0.15,0}
...
\usepackage{etoolbox}
\setlength{\LTcapwidth}{=6.95in}  %longtable caption goes full text width
...
% sections
\usepackage{titlesec}
%\titleformat{\chapter}{\LARGE\bfseries\scshape\color{ocre!60}}{\thechapter}{1em}{}[\titlerule]
\titleformat{\section}{\color{ocre!60}\Large\bfseries\uppercase}{\thesection}{1em}{}[\titlerule]
\titleformat{\subsection}{\color{black}\large\bfseries}{\thesubsection}{1em}{}
\titleformat{\subsubsection}{\color{black}\bfseries}{\thesubsubsection}{1em}{}
...
\raisebox{-2ex-0.5\myheight}{\includegraphics[height=1.5cm, width=3cm]{graphics/RegenerarLogo3.eps}}
}

\cfoot{\textit{\color{ocre!60}Evaluation of Resampling Methodologies}}
...
%------- Title Page (see defs.tex for additional title page entries)------------------------
