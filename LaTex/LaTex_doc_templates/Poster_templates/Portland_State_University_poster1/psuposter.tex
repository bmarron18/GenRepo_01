...
%poster-to-pdf sensitive to length of title; may need to adjust font size
...
Planetary-scale trends demand sustainable agriculture but no one knows what 'sustainable agriculture' really means.  Bucket lists abound but a robust and flexible methodology for adequately differentiating agricultural practices with respect to their ecological impact at the landscape scale is not available. This is because it is quite difficult to scientifically study the dynamics of the complex systems involved:  agro-ecological landscapes are coupled, complex adaptive systems that evolve in time and in space over multiple scales of both.
\begin{itemize}
